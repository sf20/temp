...
public class EL_INT_JOBCD_SYNC_RES  implements java.io.Serializable {
    ...
    private openDemo.entity.sync.elion.EL_INT_JOBCD_SYNC_RESLine[] line;
    ...
    public EL_INT_JOBCD_SYNC_RES(
           ...
           openDemo.entity.sync.elion.EL_INT_JOBCD_SYNC_RESLine[] line) {
     ...
     * @return line
     */
    public openDemo.entity.sync.elion.EL_INT_JOBCD_SYNC_RESLine[] getLine() {
        return line;
    }
     ...
     * @param line
     */
    public void setLine(openDemo.entity.sync.elion.EL_INT_JOBCD_SYNC_RESLine[] line) {
        this.line = line;
    }
